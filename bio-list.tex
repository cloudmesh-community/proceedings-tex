...
\color{blue}``\emph{Emphasis is put on ease of use, performance, documentation, and API
...
downloaded from http://scikit-learn.sourceforge.net}''\color{black}
...
\begin{tiny}
\begin{verbatim}
Warning 39 in ../hid-sp18-514/technology/abstract-apachekaraf.tex line 9: Double
space found. images ~\cite{hid-sp18-514-apachekaraf}.         ^
\end{verbatim}
\end{tiny}
...
\end{IU}
\input{../hid-sp18-414/bio-leite-john.tex}

\begin{IU}

hid-sp18-414

\url{https://github.com/cloudmesh-community/hid-sp18-414}

\url{https://github.com/cloudmesh-community/hid-sp18-414/issues}
...
\href{https://github.com/cloudmesh-community/hid-sp18-414/blob/master//technology/hid-sp18-414.bib}{../hid-sp18-414/technology/hid-sp18-414.bib}

 ERROR: No underscore allowed in citation lables: \verb| hid-sp18-414-Hyperledger_Burrow |

 ERROR: No underscore allowed in citation lables: \verb| hid-sp18-414-Hyperledger_Fabric |

 ERROR: No underscore allowed in citation lables: \verb| hid-sp18-414-Behlendorf_Interview |

 ERROR: No underscore allowed in citation lables: \verb| hid-sp18-414-Hyperledger_Indy |

 ERROR: No underscore allowed in citation lables: \verb| hid-sp18-414-Hyperledger_Iroha |

 ERROR: No underscore allowed in citation lables: \verb| hid-sp18-414-Hyperledger_Sawtooth |

 ERROR: No underscore allowed in citation lables: \verb| hid-sp18-414-Linux_Foundation_Sawtooth |

 ERROR: No underscore allowed in citation lables: \verb| hid-sp18-414-Active_Status_Iroha |
...
\end{IU}
\input{../hid-sp18-509/bio-irey-ryan.tex}

\begin{IU}

hid-sp18-509

\url{https://github.com/cloudmesh-community/hid-sp18-509}

\url{https://github.com/cloudmesh-community/hid-sp18-509/issues}

hid-sp18-509.bib is missing
